...
**NEW in v1.8.39**: **Performance Settings Sidebar** — Adaptive controls for low-end computers. Toggle **Heavy Computations** (DFA/Entropy) and **Heavy Downloads** (NOAA) to optimize speed and bandwidth.
