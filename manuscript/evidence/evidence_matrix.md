...
| Code can be openly shared and versioned for reproducibility. | Repository metadata | `LICENSE`, `README.md`, `requirements.txt`, `WARP.md`, git remote, tagged-release or archive workflow | Supported | Transparency sections | Include repo URL, license, and a frozen release identifier in the final manuscript. |
