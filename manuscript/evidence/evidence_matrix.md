...
| Code can be openly shared and versioned for reproducibility. | Repository metadata | `LICENSE`, `README.md`, `requirements.txt`, `WARP.md`, git remote, git commit `a32959258ff01e459ac9d06609f58c3cd09fee47` | Supported | Transparency sections | Include repo URL, license, branch, and commit hash in the manuscript. |
