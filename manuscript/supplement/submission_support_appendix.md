...
This appendix consolidates supplementary material that strengthens the manuscript as a systems-and-software submission without expanding unsupported scientific claims. It focuses on engineering verification, standards crosswalks, reporting positioning, and deployment prerequisites.
...
## S2. Standards and operational-reference crosswalk
...
## S3. Reporting-guideline positioning

This manuscript should remain anchored to a software/systems reporting posture unless stronger empirical evidence is added.

| Manuscript content area | Primary reporting backbone | Why it applies | Current status |
| --- | --- | --- | --- |
| Architecture, implementation, verification, and deployment surfaces | Journal-specific software/system paper guidance | The main contribution is an integrated translational software platform. | Primary backbone for submission. |
...
## S4. Non-claims and deployment prerequisites
...
## S5. Reproducibility notes for reviewers
