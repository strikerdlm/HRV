...
This is a curated starter set for the manuscript. It is not yet the full 40-60 reference list expected for final submission.

The subset currently cited in `manuscript/draft/main_manuscript_scaffold.md` has now been promoted into that draft's `References` section. This file remains the broader bibliography pool for uncited but relevant candidate sources, replacement references, and later expansion toward a journal-ready reference list.
...
## Fatigue, circadian science, and operational physiology
