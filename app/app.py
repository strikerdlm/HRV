...
def main() -> None:
	...
	with tab_about:
		st.markdown(
			...
			"[profile link](https://scienti.minciencias.gov.co/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0001814840)\n"
			...
			"[UNAL profile](https://www.medicina.bogota.unal.edu.co/directorio/ver/diego-leonel-malpica-hincapie)\n\n"
			"Project links:\n"
